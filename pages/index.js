...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <Head>
        <title>Google</title>
        <meta name="description" content="Created by Bhaskar" />
      ...
      {/* Header */}
        ...
        text-sm text-gray-700">
          ...
          <div className="flex space-x-4 items-center">
            ...
            {/* Avatar */}
            <Avatar url="https://media-exp1.licdn.com/dms/image/C5603AQFFi-CjnHvfFA/profile-displayphoto-shrink_200_200/0/1517480315800?e=1632960000&v=beta&t=iFqU1bJugF1mIv0n5oM4izwjVvGZ-5fDgaHyEHnUxPI" />
          </div>
        </header>
      {/* Body */}
